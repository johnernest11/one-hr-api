...
class ProgramTest extends TestCase
{
    ...
    private string $baseUri = self::BASE_API_URI.'/libraries/programs';

    public function test_it_can_fetch_all_programs(): void
    {
        $response = $this->withToken($this->authToken)->getJson($this->baseUri);
        $response->assertStatus(200);
    }

    public function test_it_can_search_program(): void
    {
