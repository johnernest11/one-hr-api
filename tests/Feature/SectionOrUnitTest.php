...
class SectionOrUnitTest extends TestCase
{
    use RefreshDatabase;
    ...
    private string $baseUri = self::BASE_API_URI.'/libraries/section-or-units';

    public function test_it_can_fetch_all_sections_or_units(): void
    {
        $response = $this->withToken($this->authToken)->getJson($this->baseUri);
        $response->assertStatus(200);
    }

    public function test_it_can_search_section_or_unit_by_name(): void
    {

        $query = 'communications technology';
