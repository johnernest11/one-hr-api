...
class CountryTest extends TestCase
{
    ...
    private string $baseUri = self::BASE_API_URI.'/libraries/countries';

    public function test_it_can_fetch_all_countries(): void
    {
        $response = $this->withToken($this->authToken)->getJson($this->baseUri);
        $response->assertStatus(200);
    }

    public function test_it_can_search_country(): void
    {
