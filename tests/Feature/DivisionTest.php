...
class DivisionTest extends TestCase
{
    ...
    private string $baseUri = self::BASE_API_URI.'/libraries/divisions';

    public function test_it_can_fetch_all_divisions(): void
    {
        $response = $this->withToken($this->authToken)->getJson($this->baseUri);
        $response->assertStatus(200);
    }

    public function test_it_can_search_division_by_name(): void
    {
