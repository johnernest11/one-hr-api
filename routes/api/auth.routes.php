...
Route::group(['as' => 'auth.'], function () {
    ...
    Route::middleware(['throttle:api-auth', 'lowercase_query:auth_type'])->name('store')->post('tokens', function (AuthRequest $request) use ($userService, $sanctumAuthService, $jwtAuthService) {
    ...
    Route::middleware(['throttle:api-auth', 'lowercase_query:auth_type'])->name('register')->post('register', function (AuthRequest $request) use ($userService, $sanctumAuthService, $jwtAuthService) {
        $authType = ! is_null($request->get('auth_type')) ? $request->get('auth_type') : null;
